...
void msm_anlg_cdc_hph_pa_gpio_cb(
		int (*codec_hph_pa_gpio_get)(struct snd_soc_codec *codec),
		int (*codec_hph_pa_gpio_set)(struct snd_soc_codec *codec,
...
void msm_anlg_cdc_spk_pa_gpio_cb(
		int (*codec_spk_pa_gpio_get)(struct snd_soc_codec *codec),
		int (*codec_spk_pa_gpio_set)(struct snd_soc_codec *codec,
			int enable), struct snd_soc_codec *codec)
{
	struct sdm660_cdc_priv *sdm660_cdc;
...
static const char * const spk_pa_gpio_text[] = {
	"Off", "On"
};
static const struct soc_enum spk_pa_gpio_enum =
	SOC_ENUM_SINGLE(SND_SOC_NOPM, 0,
...
static const struct snd_soc_dapm_route audio_map[] = {
	...
	{"MI8937 AW87329 PA SPK", NULL, "MI8937 AW87329 PA SPK Switch"},
#endif
...
static int msm_anlg_cdc_codec_enable_mi8937_aw87319_pa_spk(struct snd_soc_dapm_widget *w,
						struct snd_kcontrol *kcontrol,
						int event)
{
	struct snd_soc_codec *codec = snd_soc_dapm_to_codec(w->dapm);
	...
	case SND_SOC_DAPM_POST_PMU:
		dev_dbg(codec->dev,
			"%s: Enable Xiaomi MSM8937 AW87319 Speaker PA\n", __func__);
		xiaomi_msm8937_AW87319_Audio_Speaker();
		break;
	case SND_SOC_DAPM_PRE_PMD:
		dev_dbg(codec->dev,
			"%s: Disable Xiaomi MSM8937 AW87319 Speaker PA\n", __func__);
...
static int msm_anlg_cdc_codec_enable_mi8937_aw87329_pa_spk(struct snd_soc_dapm_widget *w,
						struct snd_kcontrol *kcontrol,
						int event)
{
	struct snd_soc_codec *codec = snd_soc_dapm_to_codec(w->dapm);
	...
	case SND_SOC_DAPM_POST_PMU:
		dev_dbg(codec->dev,
			"%s: Enable Xiaomi MSM8937 AW87329 Speaker PA\n", __func__);
		xiaomi_msm8937_aw87329_audio_kspk();
		break;
	case SND_SOC_DAPM_PRE_PMD:
		dev_dbg(codec->dev,
			"%s: Disable Xiaomi MSM8937 AW87329 Speaker PA\n", __func__);
...
static const struct snd_soc_dapm_widget msm_anlg_cdc_dapm_widgets[] = {
	...
	SND_SOC_DAPM_OUT_DRV("SPK PA GPIO Switch", SND_SOC_NOPM, 0, 0, &spk_pa_gpio_switch, 1),

#if IS_ENABLED(CONFIG_SND_SOC_AW87319_MI8937)
	SND_SOC_DAPM_SPK("MI8937 AW87319 PA SPK", msm_anlg_cdc_codec_enable_mi8937_aw87319_pa_spk),
	SND_SOC_DAPM_OUT_DRV("MI8937 AW87319 PA SPK Switch", SND_SOC_NOPM, 0, 0, NULL, 0),
#endif
#if IS_ENABLED(CONFIG_SND_SOC_AW87329_MI8937)
	SND_SOC_DAPM_SPK("MI8937 AW87329 PA SPK", msm_anlg_cdc_codec_enable_mi8937_aw87329_pa_spk),
	SND_SOC_DAPM_OUT_DRV("MI8937 AW87329 PA SPK Switch", SND_SOC_NOPM, 0, 0, NULL, 0),
#endif

#if IS_ENABLED(CONFIG_SND_SOC_AW87329_MI439)
	SND_SOC_DAPM_SPK("MI439 AW87329 PA SPK", msm_anlg_cdc_codec_enable_mi439_aw87329_pa_spk),
	SND_SOC_DAPM_OUT_DRV("MI439 AW87329 PA SPK Switch", SND_SOC_NOPM, 0, 0, NULL, 0),
#endif
#if IS_ENABLED(CONFIG_SND_SOC_AW87519_MI439)
	SND_SOC_DAPM_SPK("MI439 AW87519 PA SPK", msm_anlg_cdc_codec_enable_mi439_aw87519_pa_spk),
	SND_SOC_DAPM_OUT_DRV("MI439 AW87519 PA SPK Switch", SND_SOC_NOPM, 0, 0, NULL, 0),
#endif
};
